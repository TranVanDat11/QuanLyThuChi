...
public class KhoanThuAdapter extends RecyclerView.Adapter<KhoanThuAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public KhoanThuAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull KhoanThuAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
